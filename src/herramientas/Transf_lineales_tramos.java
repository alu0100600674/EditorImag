...
///////////prueba
    ...
    public PanelTramos getPanelTramos() {
        return panelTramos;
    }

    public void setPanelTramos(PanelTramos panelTramos) {
        this.panelTramos = panelTramos;
    }

    public PanelImagenTramos getPanelImResultado() {
        return panelImResultado;
    }

    public void setPanelImResultado(PanelImagenTramos panelImResultado) {
        this.panelImResultado = panelImResultado;
    }
    ...
    public BufferedImage getRefImagenOriginal() {
        return refImagenOriginal;
    }

    public void setRefImagenOriginal(BufferedImage refImagenOriginal) {
        this.refImagenOriginal = refImagenOriginal;
    }
    ...
    public void setImagenNueva(BufferedImage imagenNueva) {
    ...
    public HashMap<Integer, Integer> getTablaTransf() {
        return tablaTransf;
    }

    public void setTablaTransf(HashMap<Integer, Integer> tablaTransf) {
        this.tablaTransf = tablaTransf;
    }
   ...
   // iniciarPanelTramos();
        ...
        bAceptar.addActionListener(new ActionListener() {
            // @Override
            public void actionPerformed(ActionEvent arg0) { //MODIFICARRR
    ...
    public class EcuacionRecta {
        ...
        public HashMap<Integer, Integer> getRecta() {
            return recta;
        }

        public void setRecta(HashMap<Integer, Integer> recta) {
            this.recta = recta;
        }
    ...
    public class PanelImagenTramos extends JPanel {
        ...
        public BufferedImage getImagenTranf() {
            return imagenTranf;
        }

        public void setImagenTranf(BufferedImage imagenTranf) {
            this.imagenTranf = imagenTranf;
        }
    ...
    public class PanelTramos extends JPanel {
        ...
        public Transf_lineales_tramos getRefVTramos() {
            return refVTramos;
        }

        public void setRefVTramos(Transf_lineales_tramos refVTramos) {
            this.refVTramos = refVTramos;
        }
